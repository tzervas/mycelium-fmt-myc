...
<!-- FLEET-BADGES:BEGIN -->
[![CI](https://github.com/tzervas/mycelium-fmt-myc/actions/workflows/fleet-ci.yml/badge.svg?branch=main)](https://github.com/tzervas/mycelium-fmt-myc/actions/workflows/fleet-ci.yml?query=branch%3Amain)
[![Security](https://github.com/tzervas/mycelium-fmt-myc/actions/workflows/fleet-security.yml/badge.svg?branch=main)](https://github.com/tzervas/mycelium-fmt-myc/actions/workflows/fleet-security.yml?query=branch%3Amain)
[![Runner](https://img.shields.io/badge/runs--on-self--hosted%20podman-informational)](https://github.com/tzervas/gha-runner-ctl)
<!-- FLEET-BADGES:END -->


Mycelium-language sibling of [`tzervas/mycelium-fmt`](https://github.com/tzervas/mycelium-fmt).

| Field | Value |
|---|---|
| **Program** | PROGRAM-SELFHOST-DECOMPOSE Phase T |
| **Rust twin** | tzervas/mycelium-fmt |
