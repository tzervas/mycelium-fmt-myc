# Remap Manifest — mycelium-fmt → fmt
...
|---|---|---|---|---|---|---|
| `fmt.bin.mycfmt` | Keep | Safe | false | true | `/root/git/isolated/mycelium/crates/mycelium-fmt/src/bin/mycfmt.rs` | structure-preserving 1:1 (DN-109 §5.3-B v0 default: every emitted nodule keeps its source file's mod-tree position, no restructuring proposed) |
| `fmt` | Keep | Safe | false | true | `/root/git/isolated/mycelium/crates/mycelium-fmt/src/lib.rs` | structure-preserving 1:1 (DN-109 §5.3-B v0 default: every emitted nodule keeps its source file's mod-tree position, no restructuring proposed) |
